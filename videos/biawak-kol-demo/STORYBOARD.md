...
**Format:** 1920x1080  
**Audio:** Kokoro TTS voiceover, no music bed for the first pass  
**VO direction:** conversational, dry confidence, Indonesian community-sports context but English narration  
...
**VO:** "One badminton group. A full season of arguments. Now the table has receipts."
...
**Visual:** White canvas. The Biawak Kol logo pins the top-left. Production screenshot enters as a large tilted-but-readable product panel. Three oversized words, "THE TABLE HAS RECEIPTS", appear in staggered blocks on the right. Fine green rule lines draw across the frame.
